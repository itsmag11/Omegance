...
from src.schedulers.ddim_snrcontrol_scheduler import MyDDIMSNRControlScheduler
...
def scheduler_type_to_class(scheduler_type):
    ...
    elif scheduler_type == Scheduler_Type.DDIM_SNRControl:
        return MyDDIMSNRControlScheduler
...
def model_type_to_class(model_type):
    ...
    elif model_type == Model_Type.SDXL_SNRControl:
        return StableDiffusionXLImg2ImgSNRControlPipeline, SDXLDDIMPipeline
...
def _get_pipes(model_type, device):
    ...
    if is_float16(model_type):
        if model_type == Model_Type.SDXL_SNRControl:
    ...
    print(pipeline_inf)
    # <class 'omegance_pipelines.pipeline_stable_diffusion_xl_img2img_snrcontrol.StableDiffusionXLImg2ImgSNRControlPipeline'>
    # <class 'diffusers.pipelines.stable_diffusion_xl.pipeline_stable_diffusion_xl_img2img.StableDiffusionXLImg2ImgPipeline'>
    print(pipeline_inv)
    # <class 'src.schedulers.ddim_snrcontrol_scheduler.MyDDIMSNRControlScheduler'>
    # print(pipe_inference.components.keys())
