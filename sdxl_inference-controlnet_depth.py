...
from omegance_pipelines.utils.color_mask_grad import run_color_mask_grad
...
if __name__=='__main__':
    ...
    min_value = min(args.omega_in_back, args.omega_in_front)
    max_value = max(args.omega_in_back, args.omega_in_front)
    run_color_mask_grad(OUT_DIR, min_value, max_value)