...
from omegance_pipelines.pipeline_stable_diffusion_3_snrcontrol import StableDiffusion3SNRControlPipeline
...
if __name__=='__main__':
    ...
    if args.note != 'debug':
        ...
        OUT_DIR = os.path.join(OUTPUT_BASE, 'sd3', RUN_NAME)
    ...
    args.model_path = "stabilityai/stable-diffusion-3-medium-diffusers" #"stabilityai/stable-diffusion-3.5-medium"
    scheduler = FlowMatchEulerDiscreteSNRControlScheduler.from_pretrained(args.model_path, subfolder="scheduler")
    pipeline_text2image = StableDiffusion3SNRControlPipeline.from_pretrained(
                        args.model_path,
                        scheduler=scheduler,
